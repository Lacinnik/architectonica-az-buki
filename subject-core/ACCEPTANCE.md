...
| A08 | Сетевой отказ | Оборвать jsDelivr и отдельно вернуть worker error | Структурный fallback, модельный коэффициент отсутствует, причина видна, повторный запуск доступен | Chromium + iPhone WebKit |
